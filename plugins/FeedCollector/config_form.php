...
<div class="field">
	<label>Enter your first feed</label>
	<div class="inputs">
...
<div class="field">
	<label>And a second feed if you want</label>
	<div class="inputs">
		<input type="text" name="rss2" size="60" value="<?php echo(get_option('feedCollector_rss2'));?>">
	</div>
	<p class="explanation">For example http://feeds.bbci.co.uk/news/rss.xml</p> 
</div>
<div class="field">
